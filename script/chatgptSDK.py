...
def chat_openai_text(checked_param):
    ...
    try:
        if checked_param["openai_parameter"]:
            openai_response = openai.ChatCompletion.create(model=checked_param["model"],
        ...
        # logger.info(json.dumps(openai_response, ensure_ascii=False))
